	...
	public class TextProperties : IProperty {
		...
		public string Capitalize {
			get {
				...
				xn = this._node.SelectSingleNode ("@fo:font-variant", this.Style.Document.NamespaceManager);
				if (xn != null)
					return xn.InnerText;
				return null;
			}
			set {
				...
				xn = this._node.SelectSingleNode ("@fo:font-variant", this.Style.Document.NamespaceManager);
				if (xn == null)
					this.CreateAttribute ("font-variant", value, "fo");
				this._node.SelectSingleNode ("@fo:font-variant", this.Style.Document.NamespaceManager).InnerText = value;
			}
		}
		...
		public string FontName {
			get {
				XmlNode xn = this._node.SelectSingleNode("@style:font-name", this.Style.Document.NamespaceManager);
				if (xn != null)
					return xn.InnerText;
				return null;
			}
