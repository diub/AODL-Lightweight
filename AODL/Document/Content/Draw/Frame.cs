...
namespace AODL.Document.Content.Draw {
	...
	public class Frame : IContent, IContentContainer {
		...
		public string MeasurementFormat {
			get {
				return this._measurementFormat;
			}
		}
		...
		public string Transform {
			get {
				XmlNode xn = this._node.SelectSingleNode("@draw:transform", this.Document.NamespaceManager);
				if (xn != null)
					return xn.InnerText;
				return null;
			}
			set {
				XmlNode xn = this._node.SelectSingleNode("@draw:transform", this.Document.NamespaceManager);
				if (xn == null)
					this.CreateAttribute ("transform", value, "draw");
				this._node.SelectSingleNode ("@draw:transform", this.Document.NamespaceManager).InnerText = value;
			}
		}
		...
		public string SvgWidth {
			get {
				XmlNode xn = this._node.SelectSingleNode("@svg:width", this.Document.NamespaceManager);
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public Guid GraphicIdentifier {
			get {
				return this._graphicIdentifier;
			}
			set {
				this._graphicIdentifier = value;
			}
		}
