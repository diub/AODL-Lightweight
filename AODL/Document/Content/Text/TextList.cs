...
namespace AODL.Document.Content.Text {
	...
	/// </summary>
	public class TextList : IContent, IContentContainer {
		...
		public TextList (IDocument document, XmlNode node) {
		...
		public TextList (IDocument document, string styleName, ListStyles typ, string paragraphStyleName) {
			this.Document = document;
			this.NewXmlNode ();
			this.InitStandards ();
		...
		public TextList (IDocument document, TextList outerlist) {
			this.Document = document;
