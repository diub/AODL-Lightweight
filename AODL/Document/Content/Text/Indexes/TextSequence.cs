...
namespace AODL.Document.Content.Text.Indexes {
	...
	public class TextSequence : IText, ICloneable {
		...
		public string RefName {
			get {
				XmlNode xn = this._node.SelectSingleNode("@text:ref-name", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public string Name {
			get {
				XmlNode xn = this._node.SelectSingleNode("@text:name", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public string NumFormat {
			get {
				XmlNode xn = this._node.SelectSingleNode("@style:num-format", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public string Formula {
			get {
				XmlNode xn = this._node.SelectSingleNode("@text:formula", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
