...
namespace AODL.Document.Content.Text {
	...
	/// </summary>
	public class XLink : IText, ITextContainer, ICloneable {
		/// <summary>
		...
		public string Href {
			get {
				XmlNode xn = this._node.SelectSingleNode("@xlink:href", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public string XLinkType {
			get {
				XmlNode xn = this._node.SelectSingleNode("@xlink:type", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public string OfficeName {
			get {
				XmlNode xn = this._node.SelectSingleNode("@office:name", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public string TargetFrameName {
			get {
				XmlNode xn = this._node.SelectSingleNode("@office:target-frame-name", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
		...
		public string Show {
			get {
				XmlNode xn = this._node.SelectSingleNode("@xlink:show", this.Document.NamespaceManager) ;
				if (xn != null)
					return xn.InnerText;
				return null;
			}
