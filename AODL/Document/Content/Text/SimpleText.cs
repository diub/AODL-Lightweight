...
namespace AODL.Document.Content.Text {
	...
	/// added IContent, <see cref="AODL.Document.TextDocuments.DocumentStyles.InsertParagraphStyle(Paragraph, TextDocuments.TextDocument, bool)"/>
	/// </summary>
	public class SimpleText : IText, ICloneable, IContent {
		/// <summary>
		...
		public IStyle Style {
			...
			set {
				// diub - Dipl.-Ing. Uwe Barth 2021-04-13
